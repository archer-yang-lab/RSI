...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "compfdpI.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerobI.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerI.png"))
# plt.show()
...
# fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=16)
# Display the plot
plt.savefig(os.path.join("figure-settingII", "compfdpI0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerobI0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerI0.1.png"))
# plt.show()
