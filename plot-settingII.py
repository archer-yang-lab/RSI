...
for name in dataset_list:
    ...
    for j in range(1, 1 + n_itr):
        df = pd.read_csv(
            os.path.join("result-union", f"{name} {sample:.2f}", f"{name} {sample:.2f} {j}.csv"))
        df_ones.append(df)
    df = pd.concat(df_ones).groupby("fdp_nominals", as_index=False).mean()
    df_list.append(df)

out_dir = os.path.join('figure-settingII')
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        # line2, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs2union'],
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "compfdpII.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        # line2, = ax.plot(df_list[i]['fdpn_cs2union'], df_list[i]['powern_cs2union'],
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerobII.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        # line2, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_cs2union'],
        #                  label='Two-stage Conformal Inter: Power', marker='o', color='orange', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerII.png"))
# plt.show()
...
# fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=16)
# Display the plot
plt.savefig(os.path.join("figure-settingII", "compfdpII0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerobII0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-settingII", "comppowerII0.1.png"))
# plt.show()
