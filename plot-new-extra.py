...
for name in dataset_list:
    ...
    for j in range(1, 1 + n_itr):
        try:
            df = pd.read_csv(os.path.join(f"result-extra", model, f"{name} {sample:.2f}", f"{name} {sample:.2f} {j}.csv"))
...
# Display the plot
# plt.savefig(os.path.join("figure-paper-extra", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-paper-extra", f"compfdpcs.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowerobcs.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowercs.png"))
# plt.show()
...
# Display the plot
# plt.savefig(os.path.join("figure-paper-extra", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-paper-extra", f"compfdpsh.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowersh.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowerobsh.png"))
# plt.show()
...
out_dir = os.path.join('figure-paper-extra')
...
# Display the plot
# plt.savefig(os.path.join("figure-paper-extra", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-paper-extra", f"compfdpcs0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowerobcs0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowercs0.1.png"))
# plt.show()
...
# Display the plot
# plt.savefig(os.path.join("figure-paper-extra", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-paper-extra", f"compfdpsh0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowersh0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper-extra", f"comppowerobsh0.1.png"))
# plt.show()