...
for name in dataset_list:
    ...
    for j in range(1, 1 + n_itr):
        df = pd.read_csv(
            os.path.join("result-twostep", f"{name} {sample:.2f}", f"{name} {sample:.2f} {j}.csv"))
        df_ones.append(df)
...
for name in dataset_list:
    ...
    for j in range(1, 1 + n_itr):
        df = pd.read_csv(
            os.path.join("result-uncertainty1", f"{name} {sample:.2f}", f"{name} {sample:.2f} {j}.csv"))
        df_ones.append(df)
    df = pd.concat(df_ones).groupby("fdp_nominals", as_index=False).mean()
    sh_list.append(df)

out_dir = os.path.join('figure-papertwo')
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line1, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs2union'],
                         label='Two-stage Conformal Union: FDP', marker='o', color='steelblue', alpha=0.8)

        line2, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs2inter'],
                         label='Two-stage Conformal Inter: FDP', marker='o', color='orange', alpha=0.8)

        line3, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_bcs'],
                         label='Single-stage Conformal: FDP', marker='o', color='darkgreen', alpha=0.8)

        line4, = ax.plot(sh_list[i]['fdp_nominals'], sh_list[i]['fdpn_sh'],
                         label='Single-stage Sheridan: FDP', marker='o', color='red', alpha=0.8)


        ax.legend(loc='best', bbox_to_anchor=(5.0, -3.0), frameon=True, shadow=False, ncol=2, fontsize=22)
    else:
        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs2union'],
                label='Two-stage Conformal Union: FDP', marker='o', color='steelblue', alpha=0.8)

        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs2inter'],
                         label='Two-stage Conformal Inter: FDP', marker='o', color='orange', alpha=0.8)

        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_bcs'],
                label='Single-stage Conformal: FDP', marker='o', color='darkgreen', alpha=0.8)

        ax.plot(sh_list[i]['fdp_nominals'], sh_list[i]['fdpn_sh'],
                label='Single-stage Sheridan: FDP', marker='o', color='red', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "compfdp4.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line4, = ax.plot(df_list[i]['fdp_nominals'], sh_list[i]['fdpn_sh'],
                         label='Single-stage Sheridan: FDP', marker='o', color='red', alpha=0.8)
        ...
        ax.plot(df_list[i]['fdp_nominals'], sh_list[i]['fdpn_sh'],
                label='Single-stage Sheridan: FDP', marker='o', color='red', alpha=0.8)
...
#fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=16)
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "compfdp3.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        # Plot data for each model and conformal method
        line1, = ax.plot(df_list[i]['fdpn_cs2union'], df_list[i]['powern_cs2union'],
                         label='Two-stage Conformal Union: Power', marker='o', color='steelblue', alpha=0.8)

        line2, = ax.plot(df_list[i]['fdpn_cs2inter'], df_list[i]['powern_cs2inter'],
                         label='Two-stage Conformal Inter: Power', marker='o', color='orange', alpha=0.8)

        line3, = ax.plot(df_list[i]['fdpn_bcs'], df_list[i]['powern_bcs'],
                         label='Single-stage Conformal: Power', marker='o', color='darkgreen', alpha=0.8)

        line4, = ax.plot(sh_list[i]['fdpn_sh'], sh_list[i]['powern_sh'],
                         label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)

        ax.legend(loc='best', bbox_to_anchor=(5.0, -3.0), frameon=True, shadow=False, ncol=2, fontsize=22)
    else:
        ax.plot(df_list[i]['fdpn_cs2union'], df_list[i]['powern_cs2union'],
                label='Two-stage Conformal Union: Power', marker='o', color='steelblue', alpha=0.8)
        ax.plot(df_list[i]['fdpn_cs2inter'], df_list[i]['powern_cs2inter'],
                label='Two-stage Conformal Inter: Power', marker='o', color='orange', alpha=0.8)
        ax.plot(df_list[i]['fdpn_bcs'], df_list[i]['powern_bcs'],
                label='Single-stage Conformal: Power', marker='o', color='darkgreen', alpha=0.8)
        ax.plot(sh_list[i]['fdpn_sh'], sh_list[i]['powern_sh'],
                label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppowerob4.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppowerob3.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        # Plot data for each model and conformal method
        line1, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_cs2union'],
                         label='Two-stage Conformal Union: Power', marker='o', color='steelblue', alpha=0.8)

        line2, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_cs2inter'],
                         label='Two-stage Conformal Inter: Power', marker='o', color='orange', alpha=0.8)

        line3, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_bcs'],
                         label='Single-stage Conformal: Power', marker='o', color='darkgreen', alpha=0.8)

        line4, = ax.plot(sh_list[i]['fdp_nominals'], sh_list[i]['powern_sh'],
                         label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)

        ax.legend(loc='best', bbox_to_anchor=(5.0, -3.0), frameon=True, shadow=False, ncol=2, fontsize=22)
    else:
        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_cs2union'],
                label='Two-stage Conformal Union: Power', marker='o', color='steelblue', alpha=0.8)
        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_cs2inter'],
                label='Two-stage Conformal Inter: Power', marker='o', color='orange', alpha=0.8)
        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_bcs'],
                label='Single-stage Conformal: Power', marker='o', color='darkgreen', alpha=0.8)
        ax.plot(sh_list[i]['fdp_nominals'], sh_list[i]['powern_sh'],
                label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppower4.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line4, = ax.plot(df_list[i]['fdp_nominals'], sh_list[i]['powern_sh'],
                         label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)
        ...
        ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_bcs'],
                label='Single-stage Conformal: Power', marker='o', color='darkgreen', alpha=0.8)
        ax.plot(df_list[i]['fdp_nominals'], sh_list[i]['powern_sh'],
                label='Single-stage Sheridan: Power', marker='o', color='red', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppower3.png"))
# plt.show()
...
#fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=16)
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "compfdp40.1.png"))
# plt.show()
...
#fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=16)
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "compfdp30.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppowerob40.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppowerob30.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppower40.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-papertwo", "comppower30.1.png"))
# plt.show()