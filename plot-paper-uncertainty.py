...
out_dir = os.path.join('figure-paperun')
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        ax.legend(loc='best', bbox_to_anchor=(5.9, -3.0), frameon=True, shadow=False, ncol=3, fontsize=22)
    else:
...
# #fig.suptitle("Comparison: FDP control for all 15 Datasets", fontsize=22)

# Display the plot
plt.savefig(os.path.join("figure-paperun", "compfdp4.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "compfdp3.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line5, = ax.plot(df_list[i]['fdpn_csun'], df_list[i]['powern_csun'],
                          label='Conformal generalized: Power', marker='o', color='purple', alpha=0.8)

        ax.legend(loc='best', bbox_to_anchor=(6.08, -3.0), frameon=True, shadow=False, ncol=3, fontsize=22)
    else:
...
# Title for the entire plot
#fig.suptitle("Comparison: Power for all 15 Datasets", fontsize=22)

# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppowerob4.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppowerob3.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line5, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['powern_csun'],
                         label='Conformal generalized: Power', marker='o', color='purple', alpha=0.8)
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppower4.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppower3.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "compfdp40.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "compfdp30.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppowerob40.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppowerob30.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppower40.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paperun", "comppower30.1.png"))
# plt.show()