...
for name in dataset_list:
    ...
    for j in range(1, 1 + n_itr):
        df = pd.read_csv(
            os.path.join("result-score", f"{name} {sample:.2f}", f"{name} {sample:.2f} {j}.csv"))
        df_ones.append(df)
    df = pd.concat(df_ones).groupby("fdp_nominals", as_index=False).mean()
    df_list.append(df)

out_dir = os.path.join('figure-score')
...
# Display the plot
# plt.savefig(os.path.join("figure-score", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-score", "compfdpscore.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-score", "comppowerobscore.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-score", "comppowerscore.png"))
# plt.show()
...
# Display the plot
# plt.savefig(os.path.join("figure-score", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-score", "compfdp0.1score.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-score", "comppowerob0.1score.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-score", "comppower0.1score.png"))