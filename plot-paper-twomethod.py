...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        line1, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_cs'],
                         label='Single-stage Conformal: FDP', marker='o', color='darkgreen', alpha=0.8)

        line2, = ax.plot(df_list[i]['fdp_nominals'], df_list[i]['fdpn_sh'],
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "compfdpsingle.png"))
# plt.show()
...
for i, name in enumerate(dataset_list):
    ...
    if i == 0:
        ...
        ax.legend(loc='best', bbox_to_anchor=(4.0, -2.9), frameon=True, shadow=False, ncol=3, fontsize=12)
    else:
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "comppowerobsingle.png"))
# plt.show()
# Create a grid for subplots
fig, axs = plt.subplots(nrows=3, ncols=5, figsize=(18, 12))
axs = axs.flatten()
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "comppowersingle.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "compfdp0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "comppowerob0.1.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-paper", "comppower0.1.png"))
# plt.show()