...
out_dir = os.path.join('figure-cs')
...
# Display the plot
# plt.savefig(os.path.join("figure-cs", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-cs", "compfdpscore.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-cs", "comppowerobscore.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-cs", "comppowerscore.png"))
# plt.show()
...
# Display the plot
# plt.savefig(os.path.join("figure-cs", "compfdp3_{model}.png"))
plt.savefig(os.path.join("figure-cs", "compfdp0.1score.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-cs", "comppowerob0.1score.png"))
# plt.show()
...
# Display the plot
plt.savefig(os.path.join("figure-cs", "comppower0.1score.png"))